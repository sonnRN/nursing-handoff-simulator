const { getSharedFhirMcpClient } = require("../../backend/mcp/client/fhirMcpClient");
const { createPatientDataGateway } = require("../../backend/mcp/runtime/patientDataGateway");
const { createSyntheticFallbackHandler, isRemoteFhirDisabled } = require("../../backend/mcp/runtime/syntheticFallbackHandler");
